...
SOURCE_DIRECTORY="${HOME}/dotfiles/sublimetext3/User"
if [[ `uname -m` == 'arm64' ]]; then
  # for M1 Mac
  TARGET_DIRECTORY="${HOME}/Library/Application Support/Sublime Text 3/Packages/User"
else
  # for intel Mac
  TARGET_DIRECTORY="${HOME}/Library/ApplicationSupport/Sublime Text 3/Packages/User"
fi
